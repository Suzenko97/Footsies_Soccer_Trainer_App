...
import { createSessionFromFormData } from '../Services/statService';
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome';
import { faSave, faStopwatch, faCalendarAlt, faTachometerAlt, faBullseye, faRunning, faFutbol, faShieldAlt, faBolt } from '@fortawesome/free-solid-svg-icons';
...
const SessionForm = ({ onSessionSaved, onCancel }) => {
    ...
    const handleChange = (e) => {
        ...
        if (['duration', 'dribbling', 'shooting', 'passing', 'stamina', 'speed', 'defending', 'intensity'].includes(name)) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Use the new hybrid function instead of trackTrainingSession
            const result = await createSessionFromFormData(user.uid, formData);
    ...
    const getSkillColor = (skill) => {
        switch (skill) {
            ...
            case 'speed': return '#9c27b0';
            case 'defending': return '#795548';
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="card mb-3">
                        ...
                        <div className="card-body">
                            ...
                            {renderSkillRating('speed', 'Speed', faBolt)}
                            {renderSkillRating('defending', 'Defending', faShieldAlt)}
                        </div>
                    </div>
